...
set [] newValue Empty = Empty
set [] newValue (Node _ left right) = Node newValue left right
set (StepL:steps) newValue (Node value left right) = Node value (set steps newValue left) right
set (StepR:steps) newValue (Node value left right) = Node value left (set steps newValue right)
set _ _ Empty = Empty
